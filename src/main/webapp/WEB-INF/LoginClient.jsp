        ...
        <div class="row justify-content-md-center">
            <div class="col-12 col-md-11 col-lg-8 col-xl-7 col-xxl-6">
                <div class="p-4 p-md-5 rounded shadow-sm">
                    ...
                    <form action="${pageContext.request.contextPath}/codexconstruction/auth/signinClient" method="post" id="login-form" data-parsley-validate="">
                        <div class="row gy-3 gy-md-4 overflow-hidden text-white">
                            <div class="col-12">
                                <label for="numero" class="form-label">Télephone <span class="text-danger">*</span></label>
                                <input type="tel" class="form-control" name="numero" id="numero" placeholder="034 00 000 00" data-parsley-trigger="change" required="">
                            </div>
